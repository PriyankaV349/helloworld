...
pipeline {
  ...
  stages {
	...
	sshagent(['tomcat-new']) {
	  sh """
	    wget --user=admin --password=nexus http://3.109.59.148:8081/repository/maven-snapshots/DevOpsDemo%2FDevOpsDemo%2F1.0-SNAPSHOT%2FDevOpsDemo-1.0-20221221.140510-3.war
